...
tasks = ["Account Development", "Travel Time", "Delivery - Non Billable", "Executive Sponsorship", "Account Management", "Growth Sponsorship", "Delivery Overview", "HSBC On Call TOIL", "TOIL"]
